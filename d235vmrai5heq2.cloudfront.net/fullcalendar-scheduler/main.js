    ...
    */
    ...
    var ToolbarSection = /** @class */ (function (_super) {
        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
          /** added for zenler - start */
          var dt = new Date().toString();
          var split = dt.split(" ");
          var tzText = (dt.split("(")[1]).split(")")[0];
          /** added for zenler - end */
            var props = this.props;
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    ...
                    /** added for zenler - start */
                    children.push(createElement("span", { className: "fc-toolbar-tz" }, tzText + " - " + split[5]));
                    /** added for zenler - end */
                }
                else {
                ...
                /** added for zenler - start */
                    ...
                    children.push(createElement("button", { type: "button", title: typeof buttonHint === 'function' ? buttonHint(props.navUnit) : buttonHint, "aria-pressed": isPressed, className: buttonClasses.join(' '), onClick: buttonClick }, buttonText || (buttonIcon ? createElement("span", { className: buttonIcon }) : '')));
                /** added for zenler - end */
                }
            }
